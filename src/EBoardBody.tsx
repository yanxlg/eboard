...
class EBoardBody extends React.Component<{},IEBoardBodyState>{
    ...
    private getFrameProps(){
        const {allowDocControl,updateVScrollOffset,hasBoard,updateActiveWbNumber,addBoard,disabled,dispatchMessage,setCacheData,clearCacheMessage,clearAll,clearUndoRedo,idGenerator,config,eventEmitter,onMessageListener,pushUndoStack} = this.context;
        return {allowDocControl,updateVScrollOffset,hasBoard,updateActiveWbNumber,addBoard,disabled,dispatchMessage,setCacheData,clearCacheMessage,clearAll,clearUndoRedo,idGenerator,config,eventEmitter,onMessageListener,pushUndoStack};
    }
    render(){
